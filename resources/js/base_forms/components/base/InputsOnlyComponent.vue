        ...
        <el-form  v-loading="loading"
            ...
            <el-row>
                <template v-for="field in fields">
                    <div :class="field.class && field.class.form_group ? field.class.form_group : formData.fields.class.form_group_class">
                        <label :class="field.class && field.class.label ? field.class.label : formData.fields.class.label_class">{{ field.label }}
                        ...
                        <div :class="field.class && field.class.input_div ? field.class.input_div : formData.fields.class.input_div_class">
                            ...
                            <template v-if="field.type == 'text'">
                                <el-input  class="el-input--is-round" :disabled="loading"
