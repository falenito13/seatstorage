<link rel="stylesheet" href="{{ asset('admin_resources/css/bootstrap.min.css')}}">

<link rel="stylesheet" href="{{ asset('admin_resources/css/plugins.css')}}">
...
<link href="{{ asset('admin_resources/packages/colorbox/example2/colorbox.css') }}" rel="stylesheet" type="text/css" />
